    ...
    categories.forEach((result){
        setState(() {
          _categoryList.add(
              InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> ToDoByCategory(category: result['name'],)));
                },
                  child:  ListTile(
          ...
          child: ListView(
            children: <Widget>[
              ...
              ListTile(
                ...
                onTap: ()
                {
                  Navigator.of(context).push(new MaterialPageRoute(builder: (context) => App()));
                },
              ),
              Divider(),
              Column(
